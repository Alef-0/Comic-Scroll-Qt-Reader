...
"""PyInstaller specification for Comic Scroll Reader."""

from pathlib import Path
from PyInstaller.utils.hooks import collect_all

# Resolve repository root robustly regardless of current working directory
ROOT_DIR = Path(SPECPATH).resolve().parent if 'SPECPATH' in globals() else Path.cwd()
...
hiddenimports = [
    'comic_scroll_reader',
    'comic_scroll_reader.ui.main_window',
    'comic_scroll_reader.ui.hud_overlay',
    'comic_scroll_reader.ui.shortcuts_dialog',
    'comic_scroll_reader.ui.about_dialog',
    'comic_scroll_reader.ui.welcome_widget',
    ...
    'comic_scroll_reader.core.models',
    'comic_scroll_reader.core.resources',
    'comic_scroll_reader.core.settings',
    'rarfile',
]

# Ensure pypdfium2 binary libraries (libpdfium.so) and data are bundled
